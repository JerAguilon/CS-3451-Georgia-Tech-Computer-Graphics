...
def green_mountain():
    ...
    for i in range(40):
        for j in range(40):
            ...
            vertex(-100 + i * 5, -100 + j * 5, 0, float(i)/40, float(j) / 40)
            vertex(-95 + i * 5, -100 + j * 5, 0, float(i+1)/40, float(j)/40)
            vertex(-95 + i * 5, -95 + j * 5, 0, float(i+1)/40, float(j+1)/40)
            vertex(-100 + i * 5, -95 + j * 5, 0, float(i) /40, float(j + 1) / 40)
            endShape()
    # shader(shaders[3])
    # textureMode(NORMAL)
    # beginShape()
